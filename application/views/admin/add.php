              ...
              <div class="example">
                ...
                <form class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputSizingLarge" name="mahasiswa_tgl_lahir" placeholder="DD/MM/YYYY">
                    </div>
                  </div>
                  <div class="form-group form-group-lg">
                    <label class="col-sm-3 control-label" for="inputSizingLarge">Jenis Kelamin</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputSizingLarge" name="mahasiswa_jekel" placeholder="P / L">
                    </div>
                  </div>
                  <div class="form-group form-group-lg">
                  ...
                  <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputSizingLarge" name="userinput"  value="admin">
                    </div>
                  </div>
                  <div class="form-group form-group-lg">
