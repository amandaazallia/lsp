        ...
        <table class="table table-hover dataTable table-striped width-full" id="exampleTableAdd">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center"> 
                  <a href="<?php echo base_url('Admin/delete_krs/'.$key['krs_id']);?>" onclick="javascript: return confirm('Anda yakin akan menghapus data ini ?')" class="btn btn-icon btn-danger"><i class="icon wb-trash"></i></a>
              </td>
            </tr>
            <?php } ?>
