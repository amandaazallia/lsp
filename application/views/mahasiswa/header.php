...
<head>
  ...
  <link rel="stylesheet" href="{{url('admin/vendor/bootstrap-datepicker/bootstrap-datepicker.css')}}">
  ...
  <script src="{{url('admin/js/components/bootstrap-datepicker.js')}}"></script>
  <script src="<?php echo base_url('assets/js/components/summernote.js');?>"></script>
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        ...
        <span class="navbar-brand-text"> Mahasiswa</span>
      </div>
    </div>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li role="presentation">
                <a href="<?php echo base_url('Mahasiswa/logout');?>" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
              </li>
            </ul>
          </li>
        </ul>
        ...
        <div>
          <ul class="site-menu">
            ...
            <li class="site-menu-item">
              <a class="animsition-link" href="<?php echo base_url('Mahasiswa/index');?>" data-slug="angular">
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url('Mahasiswa/all_krs');?>" data-slug="layout-grids">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">All</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url('Mahasiswa/add_krs');?>" data-slug="layout-headers">
                    <i class="site-menu-icon " aria-hidden="true"></i>
